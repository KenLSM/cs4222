...
half_window_size = 7  # the actual window size will be (half_window_size * 2 + 1)
T1 = 2
T2 = 1
if len(sys.argv) < 2:
...
if DEBUG:
    for i in range(len(t1_eval)):
        print(",".join(map(str, [input_arr[i], var_arr[i], t1_eval[i]])))
